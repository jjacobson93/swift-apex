...
public final class JSONMapStreamParser : MapStreamParser {
    ...
    func unexpectedTokenError(reason: String) -> Error {
        return JSONMapStreamParseError.unexpectedTokenError(reason: reason, lineNumber: lineNumber, columnNumber: columnNumber)
    }

    func insufficientTokenError(reason: String) -> Error {
        return JSONMapStreamParseError.insufficientTokenError(reason: reason, lineNumber: lineNumber, columnNumber: columnNumber)
    }

    func extraTokenError(reason: String) -> Error {
        return JSONMapStreamParseError.extraTokenError(reason: reason, lineNumber: lineNumber, columnNumber: columnNumber)
    }

    func nonStringKeyError(reason: String) -> Error {
        return JSONMapStreamParseError.nonStringKeyError(reason: reason, lineNumber: lineNumber, columnNumber: columnNumber)
    }

    func invalidStringError(reason: String) -> Error {
        return JSONMapStreamParseError.invalidStringError(reason: reason, lineNumber: lineNumber, columnNumber: columnNumber)
    }

    func invalidNumberError(reason: String) -> Error {
        return JSONMapStreamParseError.invalidNumberError(reason: reason, lineNumber: lineNumber, columnNumber: columnNumber)
    }
}
